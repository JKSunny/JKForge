...
@dataclass
class GlobalEternalJK(GlobalClient):
    install_dir     : str                       = "JediAcademy"
    build_class     : ClassVar[type[Build]]     = BuildEternalJK
    frontend: ClassVar[GlobalClientFrontend]    = GlobalClientFrontend(
        badge_class = "badge-eternaljk",
        badge_icon  = "fa-solid fa-jedi"
    )